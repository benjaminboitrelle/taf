...
public:
  ...
  {
    AlignDebug = aDebug;
    cout << "MAlign debug updated to " << AlignDebug << endl;
  } // JB 2011/06/18
  ...
  DPrecAlign *AlignMimosa(DPrecAlign *initAlignment, TFile *aCorFile, const std::string MimosaResultDir, Double_t aDistance); // new parameter, JB 2012/05/11
